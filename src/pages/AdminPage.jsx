...
const sPc = {
  page:       { minHeight: '100svh', background: '#f5f5f5', padding: '16px' },
  container:  { background: 'white', border: '0.5px solid #eee', borderRadius: 12, maxWidth: 1400, margin: '0 auto', overflow: 'hidden', display: 'flex', flexDirection: 'column' },
  header:     { background: '#f9f9f9', padding: '14px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '0.5px solid #eee' },
  headerTitle:{ fontSize: 16, fontWeight: 500, color: '#222' },
  tabs:       { display: 'flex', borderBottom: '0.5px solid #eee' },
  tab:        { flex: 'none', width: 120, padding: '12px 0', fontSize: 14, fontWeight: 400, border: 'none', background: 'none', borderBottom: '2px solid transparent', color: '#888', cursor: 'pointer' },
  tabActive:  { fontWeight: 500, color: '#1855A0', borderBottom: '2px solid #1855A0' },
  monthBar:   { display: 'flex', alignItems: 'center', padding: '10px 20px', borderBottom: '0.5px solid #eee' },
  monthBtn:   { border: 'none', background: 'none', fontSize: 20, color: '#888', cursor: 'pointer', padding: '0 6px' },
  monthLabel: { fontSize: 15, fontWeight: 500, minWidth: 100, textAlign: 'center' },
  twoPane:    { display: 'grid', gridTemplateColumns: '280px 1fr', minHeight: 'calc(100svh - 200px)' },
  leftPane:   { borderRight: '0.5px solid #eee', display: 'flex', flexDirection: 'column' },
  leftHeader: { padding: '10px 14px', fontSize: 12, fontWeight: 500, color: '#888', background: '#fafafa', borderBottom: '0.5px solid #eee' },
  empItem:    { display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderBottom: '0.5px solid #eee', cursor: 'pointer', transition: 'background 0.15s' },
  rightPane:  { display: 'flex', flexDirection: 'column', minHeight: 0 },
  rightHeader:{ padding: '12px 16px', borderBottom: '0.5px solid #eee', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
};